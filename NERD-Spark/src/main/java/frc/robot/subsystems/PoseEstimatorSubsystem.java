...
public class PoseEstimatorSubsystem extends SubsystemBase {
  ...
  public PoseEstimatorSubsystem(PhotonCamera photonCamera, SwerveSubsystem drivetrainSubsystem) {
    ...
    poseEstimator = new SwerveDrivePoseEstimator( DriveConstants.kDriveKinematics,
        drivetrainSubsystem.getGyroscopeRotation(), drivetrainSubsystem.getServeModulePositions(),
  ...
  public void periodic() {
    ...
    poseEstimator.updateWithTime(
      ...
      drivetrainSubsystem.getServeModulePositions());
   ...
   */
  public void setCurrentPose(Pose2d newPose, SwerveModulePosition[] newSwervePositions) {
    drivetrainSubsystem.zeroHeading();
    poseEstimator.resetPosition(drivetrainSubsystem.getGyroscopeRotation(),newSwervePositions,newPose );
  }
  ...
  public void resetFieldPosition() {
    ...
    poseEstimator.resetPosition(
      drivetrainSubsystem.getGyroscopeRotation(),new SwerveModulePosition[] {
