...
public class NerdSparkAprTagCommand extends CommandBase {
   ...
   */
  public NerdSparkAprTagCommand(PhotonCamera photonCamera, ExampleSubsystem subsystem, int tagToChase) {
