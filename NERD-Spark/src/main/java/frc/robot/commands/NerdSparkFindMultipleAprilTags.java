...
public class NerdSparkFindMultipleAprilTags extends CommandBase {
   ...
   */
  public NerdSparkFindMultipleAprilTags(PhotonCamera photonCamera, ExampleSubsystem subsystem, int tagToChase) {
